...
new_java_lang_StringBuilder:() => Object.seal({0:600,1:0,2:null,3:0}),
...
new_java_lang_OutOfMemoryError:() => Object.seal({0:976,1:0,2:null,3:null,4:null,5:null}),
new_java_lang_ThreadLocal:() => Object.seal({0:1400,1:0,2:0}),
new_java_util_concurrent_atomic_AtomicInteger:() => Object.seal({0:1904,1:0,2:0}),
get_i32:(a,i) => a[i],
array_new_i32:(l)=>Object.seal({0:408,1:0,2:new Int32Array(l)}),
new_java_lang_StringIndexOutOfBoundsException:() => Object.seal({0:504,1:0,2:null,3:null,4:null,5:null}),
new_java_lang_NullPointerException:() => Object.seal({0:2044,1:0,2:null,3:null,4:null,5:null}),
ref_eq:(a,b) => a === b,
new_java_lang_IllegalArgumentException:() => Object.seal({0:828,1:0,2:null,3:null,4:null,5:null}),
get_anyref:(a,i) => a[i],
array_new_java_lang_StackTraceElement:(l)=>Object.seal({0:912,1:0,2:Object.seal(new Array(l).fill(null))}),
set_anyref:(a,v,i) => a[i]=v,
array_get_i32:(a,i)=>a[2][i],
new_java_lang_String:() => Object.seal({0:324,1:0,2:null,3:0}),
get_externref:(a,i) => a[i],
new_java_util_Collections$UnmodifiableRandomAccessList:() => Object.seal({0:1716,1:0,2:null,3:null}),
array_new_java_lang_Throwable:(l)=>Object.seal({0:1368,1:0,2:Object.seal(new Array(l).fill(null))}),
...
array_new_i8:(l)=>Object.seal({0:376,1:0,2:new Uint8Array(l)}),
array_len:(a)=>a[2].length,
new_java_util_ArrayList:() => Object.seal({0:1316,1:0,2:0,3:null}),
new_java_lang_Class:() => Object.seal({0:1280,1:0,2:0,3:0}),
